...
class PersonalProfileFollowers extends StatefulWidget {
  const PersonalProfileFollowers({Key key}) : super(key: key);

  @override
  _PersonalProfileFollowersState createState() => _PersonalProfileFollowersState();
}

class _PersonalProfileFollowersState extends State<PersonalProfileFollowers> {
