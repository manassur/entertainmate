...
class Complete2 extends StatefulWidget {
  @override
  _Complete2State createState() => _Complete2State();
}

class _Complete2State extends State<Complete2> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Text('Industrial and Systems Engineering, PhD\nData scientist & ML engineering    \nDance | Music | Party     \nAtlanta, GA', style:TextStyle(fontSize: 15.0) ,),
              ),
            ),
            SizedBox(
              height: 10,
